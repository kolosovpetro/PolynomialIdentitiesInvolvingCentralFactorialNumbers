...
\title[Mathematica documentation]
...
\begin{document}
    ...
    \input{01-central-factorial}
    \input{02-central-factorial-number}
    \input{03-central-factorial-number-identities}
    \input{04-odd-power-identities}
    \input{05-power-identities}
